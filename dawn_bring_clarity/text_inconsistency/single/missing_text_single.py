...
def find_missing_texts(light_texts: List[Dict[str, Any]], dark_texts: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    """
    threshold = 85  # Fixed: was incorrectly defined as a tuple
...
if __name__ == '__main__':
    ...
    missing_text(light_image_path, dark_image_path, light_json_path, dark_json_path, output_image_path, output_json_path)