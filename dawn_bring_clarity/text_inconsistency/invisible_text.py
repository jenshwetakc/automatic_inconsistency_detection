...
# update the code to add the summary file
...
invisible text - check whether the text are visible following the WCAG guidelines
...
def check_contrast_and_draw_bounding_boxes(light_image, dark_image, light_texts, dark_texts, output_image_path,
    ...
    test_threshold = 2
    summary_data = []  # overall summary of the file
    to_remove = []
    light_failed_text = []
    dark_failed_text = []
                ...
                if text_color_candidates:
                    ...
                    if new_ratio < contrast_threshold:
                        ...
                        if new_ratio < test_threshold:
                            ...
                            if text_content in [item["Text"] for item in dark_failed_text]:
                                dark_text_entry = next(
                                    (item for item in dark_failed_text if item["Text"] == text_content), None
                                )
                            ...
                            dark_failed_text = [
                                item for item in dark_failed_text if item["Text"] not in to_remove
                            ]
    ...
    # to save the overall file infromation
